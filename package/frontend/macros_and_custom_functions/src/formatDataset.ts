...
function formatDataset() {
  ...
  var noHeadersRange = fullDataRange.offset(1, 1, fullDataRange.getNumRows() - 1, fullDataRange.getNumColumns() - 1);
...
function formatDates_(colIndex) {
  ...
  sheet.getRange(2, colIndex, sheet.getLastRow() - 1, 1).setNumberFormat('');
}
